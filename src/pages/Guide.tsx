  ...
  return (
    ...
    <GuideContainer>
      ...
      <div className="guide-container pxy-10">
        <button className="btn xl bg-danger">[링크]<a className="text-white" target="_blank" href="https://hwik.atlassian.net/wiki/spaces/AIO/pages/2287960068">디자인가이드 바로가기</a></button>
        <button className="btn xl bg-warning">
          [링크]<a target="_blank" href="https://www.figma.com/file/DhhrbdUtd8OPIVOBRVZKAO/%5BINT%5D-phase2_passengerAPP_design?node-id=32%3A2&t=mkRjvGlB78oSltjV-1">피그마
          바로가기</a></button>
